            ...
            <div className="relative z-10 flex flex-col lg:flex-row gap-16 items-center">
              <div className="flex-1 space-y-8">
                ...
                <form onSubmit={handleConsult} className="relative group max-w-xl">
                  ...
                  <button 
                    disabled={loading}
                    className="mt-6 w-full md:w-auto bg-[#A8D5BA] hover:bg-[#B5E5CF] disabled:bg-[#7FB394] text-black font-black py-5 px-12 rounded-2xl transition-all flex items-center justify-center gap-3 shadow-2xl hover:shadow-[#A8D5BA]/30 text-lg uppercase"
                  >
                    {loading ? (
